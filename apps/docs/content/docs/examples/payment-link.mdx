---
title: Payment link
description: Create a hosted Wompi checkout link from an Astro API route and return its public URL.
sidebar:
  label: Payment link
---
...
```ts title="src/pages/api/payment-link.ts"
...
Your application should read Wompi keys from **server environment variables**.
