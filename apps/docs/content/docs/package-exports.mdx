...
:::note[Changed in v3]
The package was flattened to three code entry points. The root exports both client
...
- `WompiPayoutsClient`: calls the separate Pagos a Terceros API for bank and BRE-B dispersion batches, transactions, banks, accounts, limits, reports, health, and sandbox recharges
